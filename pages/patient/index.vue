      ...
      <div class="flex space-x-6 border-b p-2 bg-white rounded-xl border-gray-200 py-2">
        ...
        <div class="flex flex-col">
          <div>
            ...
            <p class=" text-xs text-gray-400">This glass bottle comes with a mesh insert for steeping tea or cold-brewing coffee...</p>
          </div>
          <div class="flex flex-1 mt-2">
            <dl class="flex flex-col space-x-4 divide-y divide-gray-200 text-sm text-green-500 sm:space-x-6">
