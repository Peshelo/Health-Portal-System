        ...
        <div class="flex flex-auto flex-col">
          ...
          <div class="mt-6 flex flex-1 items-end">
            <dl class="flex space-x-4 divide-x divide-gray-200 text-sm sm:space-x-6">
              <div class="flex">
                <dt class="font-medium text-gray-00">Start:</dt>
                <dd class="ml-2 text-gray-500">{{ appoint.start }}</dd>
              </div>
              <div class="flex pl-4 sm:pl-6">
                <dt class="font-medium text-gray-900">End:</dt>
                <dd class="ml-2 text-gray-500">{{ appoint.end }}</dd>
              </div>
            </dl>
          </div>
        </div>
    ...
    <li class="py-4">
      <div class="flex space-x-3">
        ...
        <div class="flex-1 space-y-1">
          ...
          <p class="text-xs text-gray-500">Deployed Workcation (2d89f0c8 in master) to production</p>
        </div>
      </div>
    </li>
