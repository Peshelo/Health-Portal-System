...
<div class="min-h-screen bg-gray-100">
  <div class="py-6">
    ...
    <div class="w-full max-w-3xl lg:grid lg:max-w-7xl lg:grid-cols-12 lg:gap-8 ">
      ...
      <main class="lg:col-span-10 xl:col-span-8 w-full">
        <h1 class="text-xl bbold">Upcoming Appointments</h1>

        <div class="w-full">
  <div class="w-full">

    <div v-for="(appoint,index) in appointments" :key="index" class="border-t shadow-md border-gray-200 my-2 w-full">
  ...
  <ul role="list" class="divide-y divide-gray-200">
    <li v-for="(doctor,index) in doctors" :key="index" class="py-4">
    ...
    <li class="py-4">
      <div class="flex space-x-3">
        ...
        <div class="flex-1 space-y-1">
          <div class="flex items-center justify-between">
            <h3 class="text-sm font-medium">Dr. Gomo</h3>
            <p class="text-sm text-gray-500">1h</p>
          </div>
          <p class="text-xs text-gray-500">Your lab results have been uploaded</p>
        </div>
      </div>
    </li>
    <li class="py-4">
