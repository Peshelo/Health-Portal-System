...
<h1 v-if="loading">Loading Data...</h1>
      <div v-else class="grid grid-cols-1 my-5 max-md:grid-cols-1 gap-2">
      ...
      <div class="flex space-x-6 border-b p-5 bg-white border-t-4 border-blue-600  rounded-xl">
        ...
        <div class="flex flex-col">
          <div>
            ...
            <p class=" text-sm text-gray-400">This glass bottle comes with a mesh insert for steeping tea or cold-brewing coffee. Pour from any angle and remove the top for easy cleaning.</p>
          </div>
