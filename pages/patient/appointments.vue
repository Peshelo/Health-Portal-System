...
<h2>Today's Appointments</h2>
          ...
          <div class="flex flex-1 mt-2">
            <dl class="flex space-x-4 divide-x divide-gray-200 text-sm text-green-500 sm:space-x-6">
              <div class="flex rounded-md text-xs">
                ...
                <dd class="ml-2">{{ appoint.start }}</dd>
              </div>
              <div class="flex pl-4 sm:pl-6 text-xs">
                <dt class="font-medium ">End:</dt>
                <dd class="ml-2">{{ appoint.end }}</dd>
              </div>
              <div class="flex pl-4 sm:pl-6">
                <dt class="font-medium "><button class="text-red-600">Cancel</button></dt>
                <dd class="ml-2 text-blue-500">View</dd>
              </div>
            </dl>
          </div>
        </div>
    ...
    <div class="w-1/3 p-5 h-fit shadow-lg bg-white rounded-lg text-center">
      <h1 class="text-red-600">Appointment View</h1>
      <img src="https://th.bing.com/th/id/R.77f5fa04e7b5d8312ca224d569c7ae45?rik=8aD2rVG5C%2bIdSA&riu=http%3a%2f%2fi.huffpost.com%2fgen%2f2348088%2fimages%2fo-DOCTOR-facebook.jpg&ehk=XuwCSSQqaGsNGdXL8pTOU0TrJZjsG19T3pf80cONGP8%3d&risl=&pid=ImgRaw&r=0" alt="" class="w-full h-60 rounded-xl object-cover p-2 text-center">
      <h1 class="text-xl font-bold">Dr. Peshel Gomo</h1>
      <p class="text-gray-500">Dematologist</p>
      <div class="my-5">
        <p class="text-sm text-gray-500">Appointment created on: 23-43-2023</p>
        <p class="text-md">Description: Lorem ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus neque, corrupti illo et fuga animi.</p>
        <div class="bg-green-200 rounded-md w-full border-green-700 p-4 text-center my-4">Pending</div>
        <div class="grid grid-cols-2 my-2">
          <p class="w-full p-2 border-t text-start">Mobile</p>
          <p class="w-full p-2 border-t text-start">0774343535</p>
          <p class="w-full p-2 border-t text-start">Amount Paid</p>
          <p class="w-full p-2 border-t text-start">40USD</p>
          <p class="w-full p-2 border-t text-start">Start</p>
          <p class="w-full p-2 border-t text-start"> 09:00hrs</p>
          <p class="w-full p-2 border-t text-start">End</p>
          <p class="w-full p-2 border-t text-start">09:30hrs</p>
