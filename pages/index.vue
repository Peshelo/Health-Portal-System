...
<div class="bg-gray-200 md:overflow-hidden">
  <div class="px-4 py-16">
    <div class="relative w-full md:max-w-2xl md:mx-auto text-center">
      <h1
        class="head font-bold text-gray-700 text-xl sm:text-2xl md:text-5xl leading-tight mb-6"
      >
        A simple and smart tool that will help you manage your health
      </h1>

      <p class="text-gray-600 md:text-xl md:px-18">
        Its <b>Simple</b>, Its <b>Fast</b> and Its <b>efficient</b>,
      </p>
